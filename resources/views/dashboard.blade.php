...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    ...
    <ul class="nav nav-pills nav-stacked" style="border-right:1px solid black">
        ...
        <li><a href="users"><i class="fa fa-tags"></i>Users</a></li>
        <li><a href="searchroom"><i class="fa fa-tags"></i>Rooms</a></li>
        <li><a href="msg"><i class="fa fa-tags"></i>Messages</a></li>
        <li><a href="room"><i class="fa fa-tags"></i>room</a></li>
        <li><a href="#"><i class="fa fa-tags"></i> Referal Code</a></li>
        <li><a href="#"><i class="fa fa-history"></i> Redeem History</a></li>
        @if (Route::has('password.request'))
        <li><a class="fa fa-lock" class="btn btn-link" href="{{ route('password.request') }}">
